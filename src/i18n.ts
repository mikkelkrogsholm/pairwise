...
const da: Catalog = {
  ...
  "lang.label": "Sprog",
  "upload.drop.images": "Slip billeder her",
  "upload.drop.image": "Slip et billede her",
  "upload.drop.audios": "Slip lydfiler her",
  "upload.drop.audio": "Slip en lydfil her",
  "upload.drop.videos": "Slip videoer her",
  "upload.drop.video": "Slip en video her",
  "upload.hint.multiple": "Vælg eller træk flere filer hertil",
  "upload.hint.single": "Vælg eller træk én fil hertil",
  "upload.remove": "Fjern",
  ...
  "privacy.summary.body":
    "Appen har ingen brugerprofiler, ingen e-mail-login, ingen indbygget analytics og ingen reklamecookies. Den gemmer dog teknisk nødvendige cookies, stemmer, forslag og eventuelle uploads, fordi det er nødvendigt for at gennemføre et survey.",
  ...
  "privacy.data.2": "Stemmer, spring-over-handlinger og viste par knyttet til en tilfældig, signeret voter-id-cookie, der kun gælder for det enkelte survey.",
  ...
  "privacy.cookies.body":
    "Appen bruger kun teknisk nødvendige og funktionelle cookies: en survey-specifik `pwid_*` holder styr på, hvilke par en deltager har set og besvaret, og `lang` husker sprogvalg. Tema gemmes i localStorage. Der bruges ikke statistik-, tracking- eller marketingcookies i appen.",
  ...
  "privacy.third.body":
    "Appen sender ikke data til en analytics-tjeneste. Lokale uploads serveres fra instansen selv. Hvis et survey bruger YouTube-videoer, kontakter deltagerens browser først YouTube/Google, når deltageren vælger at indlæse videoen.",
  ...
  "vote.closed": "Afstemningen er lukket. Du kan stadig se resultaterne.",
  "vote.done": "Der er ikke flere par at vise lige nu. Tak for dine svar.",
  "vote.limit": "Du har nået grænsen for svar i denne afstemning. Tak for dine svar.",
  "vote.load_video": "Indlæs YouTube-video",
  "vote.zoom": "Zoom",
  "vote.zoom_image": "Forstør billede",
  "vote.pick_image": "Vælg dette billede",
  ...
  "results.meta": "{w} sejre · {l} tab · {a} sammenligninger",
  "results.method": "Beregnet med",
  "results.method_title": "Sådan skal scoren læses",
  ...
  "admin.lifecycle.title": "Survey-status",
  "admin.lifecycle.help": "Luk stopper nye stemmer og deltagerforslag. Arkiv skjuler stemmesiden, men beholder resultater og admin.",
  "admin.lifecycle.status": "Status",
  "admin.lifecycle.delete": "Slet survey",
  "admin.lifecycle.confirm_delete": "Slet hele surveyet og lokale uploads permanent?",
  "admin.status.open": "Åben",
  "admin.status.closed": "Lukket",
  "admin.status.archived": "Arkiveret",
  "admin.access.title": "Admin-adgange",
  "admin.access.help": "Del separate admin-links med samarbejdspartnere. Hvert link kan fjernes uden at ændre de andre.",
  "admin.access.new": "Nyt admin-link",
  "admin.access.new_hint": "Kopiér linket nu. Af sikkerhedshensyn vises det kun i fuld længde denne ene gang.",
  "admin.access.current": "(nuværende)",
  "admin.access.created": "Oprettet",
  "admin.access.rotated": "Roteret",
  "admin.access.last_used": "Sidst brugt",
  "admin.access.label_ph": "Navn, fx Sofie eller ekstern reviewer",
  "admin.access.add": "Opret admin-link",
  "admin.access.revoke": "Fjern",
  "admin.access.rotate": "Rotér dette link",
  "admin.access.confirm_revoke": "Fjern dette admin-link?",
  "admin.access.confirm_rotate": "Rotér dit nuværende admin-link? Det gamle link stopper med at virke.",
...
const en: Catalog = {
  ...
  "lang.label": "Language",
  "upload.drop.images": "Drop images here",
  "upload.drop.image": "Drop one image here",
  "upload.drop.audios": "Drop audio files here",
  "upload.drop.audio": "Drop one audio file here",
  "upload.drop.videos": "Drop videos here",
  "upload.drop.video": "Drop one video here",
  "upload.hint.multiple": "Choose or drop multiple files",
  "upload.hint.single": "Choose or drop one file",
  ...
  "privacy.summary.body":
    "The app has no user profiles, no email login, no built-in analytics, and no advertising cookies. It does store technically necessary cookies, votes, suggestions, and optional uploads because that is necessary to run a survey.",
  ...
  "privacy.data.2": "Votes, skips, and shown pairs linked to a random signed voter-id cookie that only applies to the individual survey.",
  ...
  "privacy.cookies.body":
    "The app only uses technically necessary and functional cookies: a survey-specific `pwid_*` tracks which pairs a participant has seen and answered, and `lang` remembers language choice. Theme is stored in localStorage. The app does not use analytics, tracking, or marketing cookies.",
  ...
  "privacy.third.body":
    "The app does not send data to an analytics service. Local uploads are served by the instance itself. If a survey uses YouTube videos, the participant's browser only contacts YouTube/Google after the participant chooses to load the video.",
  ...
  "vote.closed": "Voting is closed. You can still view the results.",
  "vote.done": "No more pairs to show right now. Thanks for your answers.",
  "vote.limit": "You have reached the answer limit for this vote. Thanks for your answers.",
  "vote.load_video": "Load YouTube video",
  "vote.zoom": "Zoom",
  "vote.zoom_image": "Zoom image",
  "vote.pick_image": "Choose this image",
  ...
  "results.meta": "{w} wins · {l} losses · {a} comparisons",
  "results.method": "Calculated with",
  "results.method_title": "How to read the score",
  ...
  "admin.lifecycle.title": "Survey status",
  "admin.lifecycle.help": "Closed stops new votes and participant suggestions. Archived hides the voting page while keeping results and admin.",
  "admin.lifecycle.status": "Status",
  "admin.lifecycle.delete": "Delete survey",
  "admin.lifecycle.confirm_delete": "Delete the whole survey and local uploads permanently?",
  "admin.status.open": "Open",
  "admin.status.closed": "Closed",
  "admin.status.archived": "Archived",
  "admin.access.title": "Admin access",
  "admin.access.help": "Share separate admin links with collaborators. Each link can be removed without changing the others.",
  "admin.access.new": "New admin link",
  "admin.access.new_hint": "Copy this link now. For security, it is only shown in full this one time.",
  "admin.access.current": "(current)",
  "admin.access.created": "Created",
  "admin.access.rotated": "Rotated",
  "admin.access.last_used": "Last used",
  "admin.access.label_ph": "Name, e.g. Sofie or external reviewer",
  "admin.access.add": "Create admin link",
  "admin.access.revoke": "Remove",
  "admin.access.rotate": "Rotate this link",
  "admin.access.confirm_revoke": "Remove this admin link?",
  "admin.access.confirm_rotate": "Rotate your current admin link? The old link will stop working.",
