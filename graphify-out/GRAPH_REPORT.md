...
## Corpus Check
- 35 files · ~75,722 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 394 nodes · 662 edges · 29 communities (22 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de2c28dc`
...
Cohesion: 0.22
Nodes (14): Candidate, candidateWeight(), chooseBalancedCandidate(), choosePair(), chooseSampledPair(), ChosenPair, ideaShows(), pairShows() (+6 more)
...
Cohesion: 0.22
Nodes (8): Choosing a Method, Interpreting Scores, Methods and Scoring, Pair Selection: Balanced Adaptive, Pairwise Voting Flow, Score Method: Bayesian Win Rate, Score Method: Bradley-Terry, Score Method: Raw Win Rate
...
- **Why does `Idea` connect `Community 15` to `Community 0`, `Community 1`, `Community 4`, `Community 8`?**
